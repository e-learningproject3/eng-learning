    ...
    <div class="page-section py-3 mt-md-n5 custom-index">
      <div class="container">
        ...
        <div class="container">
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/a1_s.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('elementary_speaking')}}"><span>Elementary (A1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/a2_s.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('pre_elementary_speaking')}}"><span>Pre-intermediate (A2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/b1_s.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('intermediate_speaking')}}"><span>Intermediate (B1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/b2_s.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('upper_intermediate_speaking')}}"><span>Upper intermediate (B2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/c1_s.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('advanced_speaking')}}"><span>Advanced (C1)</a></h5>
        ...
        <!-- <div class="row justify-content-center">
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card-service wow fadeInUp">
              ...
              <p><a href="{{url('elementary_speaking')}}"><span>Elementary (A1)</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card-service wow fadeInUp">
              ...
              <p><a href="{{url('pre_elementary_speaking')}}"><span>Pre-intermediate (A2)</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card-service wow fadeInUp">
              ...
              <p><a href="{{url('intermediate_speaking')}}"><span>Intermediate (B1)</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card-service wow fadeInUp">
              ...
              <p><a href="{{url('upper_intermediate_speaking')}}"><span>Upper intermediate (B2)</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card-service wow fadeInUp">
              ...
              <p><a href="{{url('advanced_speaking')}}"><span>Advanced (C1)</a></p>
            </div>
          </div>
        speaking
