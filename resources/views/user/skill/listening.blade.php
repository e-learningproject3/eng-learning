    ...
    <!-- <div class="page-section">
      <div class="container">
        ...
        <div class="container">
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/a1.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('elementary')}}"><span>Elementary (A1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/a2.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('pre_elementary')}}"><span>Pre-intermediate (A2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/b1.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('intermediate')}}"><span>Intermediate (B1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/b2.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('upper_intermediate')}}"><span>Upper intermediate (B2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              ...
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('advanced')}}"><span>Advanced (C1)</a></h5>
      ...
      <!-- <div class="row justify-content-center">
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card-service wow fadeInUp">
            ...
            <p><a href="{{url('elementary')}}"><span>Elementary (A1)</a></p>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card-service wow fadeInUp">
            ...
            <p><a href="{{url('pre_elementary')}}"><span>Pre-intermediate (A2)</a></p>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card-service wow fadeInUp">
            ...
            <p><a href="{{url('intermediate')}}"><span>Intermediate (B1)</a></p>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card-service wow fadeInUp">
            ...
            <p><a href="{{url('upper_intermediate')}}"><span>Upper intermediate (B2)</a></p>
          </div>
        </div>
        ...
        <div class="col-md-4 py-3 py-md-0">
          ...
          <div class="card-service wow fadeInUp">
            ...
            <p><a href="{{url('advanced')}}"><span>Advanced (C1)</a></p>
          </div>
        </div>
      </div>
