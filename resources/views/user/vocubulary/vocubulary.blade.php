...
<body>
    ...
    <div class="bg-light">
        ...
        <div class="container">
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/a1_v.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('elementary_vocub')}}"><span>Elementary (A1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/a2_v.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('pre_elementary_vocub')}}"><span>Pre-intermediate (A2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/b1_v.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('intermediate_vocub')}}"><span>Intermediate (B1)</a></h1>
            ...
            <div class="card">
              <img class="card-img-top" src="../assets/img/b2_v.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('upper_intermediate_vocub')}}"><span>Upper intermediate (B2)</a></h1>
          ...
          <div class="card-deck">
            <div class="card">
              <img class="card-img-top" src="../assets/img/c1_v.jpg" alt="Card image cap">
              <div class="card-body">
                <h1 class="card-title"><a href="{{url('advanced_vocub')}}"><span>Advanced (C1)</a></h5>
